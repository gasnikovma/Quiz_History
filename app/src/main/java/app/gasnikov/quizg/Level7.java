...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        excerpt=(TextView)findViewById(R.id.variant3);
        ...
        l1back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent(Level7.this,Levels.class);
                                    ...
                                    public boolean onKey(View v, int keyCode, KeyEvent event) {
                                                ...
                                                (keyCode == KeyEvent.KEYCODE_ENTER))
                                        {
                                            ...
                                            if(intranswer.equals(a[2])||intranswer.equals(a[3])||intranswer.equals(a[4])){
                                                db.collection("question7").document("q"+String.valueOf(random.nextInt(10)+1)).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                                    @Override
                                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            if (document.exists()) {
                                                                ...
                                                                a[5]=(String)document.get("excerpt");
        ...
        dial.setImageResource(R.drawable.l7);
        TextView question= d.findViewById(R.id.explanation);
        question.setText(R.string.lseven);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Level7.this,Levels.class);
                startActivity(i);
                finish();
                d.dismiss();
            }
