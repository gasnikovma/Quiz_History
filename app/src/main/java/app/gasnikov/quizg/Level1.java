...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            answers[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (v.getId() == answers[finalI].getId() && ranswer == (finalI+1)) {
                        ...
                        db.collection("question1").document("q"+String.valueOf(random.nextInt(18)+1)).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            @Override
        ...
        dial.setImageResource(R.drawable.lenta_vremeni);
        TextView question= d.findViewById(R.id.explanation);
        question.setText(R.string.lone);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Level1.this,Levels.class);
                startActivity(i);
                finish();
                d.dismiss();
            }
