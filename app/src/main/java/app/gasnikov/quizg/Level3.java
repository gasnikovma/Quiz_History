...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                                      ...
                                      public boolean onKey(View v, int keyCode, KeyEvent event) {
                                                  ...
                                                  (keyCode == KeyEvent.KEYCODE_ENTER))
                                          {
                                              ...
                                              if(intranswer.equals(a[2])||intranswer.equals(a[3])||intranswer.equals(a[4])){
                                                  db.collection("question3").document("q"+String.valueOf(random.nextInt(14)+1)).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                                      @Override
        ...
        dial.setImageResource(R.drawable.l3);
        TextView question= d.findViewById(R.id.explanation);
        question.setText(R.string.lthree);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(Level3.this,Levels.class);
                startActivity(i);
                finish();
                d.dismiss();
            }
